...
const PropertyDetails = () => {
    ...
    const { mutate } = useDelete(); /*mutate allows us to quickly delete a resource */
    const { id } = useParams();
...
/* if I am the currently logged in user, I can see the edit and delete buttons on the frontend, if 
I'm not, I'll see a dummy message and call buttons. But in this case, I am */ 
